...
export default function BinarySearch() {
    ...
    return (
        <div className='BinarySearch-page'>
            <div className='BinarySearch-title'>
                JavaScript 二分查找
            </div>
            <Card>
                <p>
                ...
                <p>在上面的代码中，我们可以看到，递归和迭代两种方法都是基于同样的思想，不断地将查找范围缩小，直到找到目标元素或者缩小到不可能找到目标元素的范围。</p>
                <p>两种方法的区别在于，递归方法是使用函数调用栈来保存状态，而迭代方法是使用循环和变量来保存状态。对于大部分情况来说，迭代方法更加高效，因为它避免了函数调用栈的开销。</p>
                <p>两种方法都需要注意的是数组是有序的，且需要先确定好左右边界。</p>
                <p>这里的代码只是一个简单的二分查找示例，在实际使用中，还需要根据具体需求进行调整和优化。</p>
            </Card >
        </div >
    )
}